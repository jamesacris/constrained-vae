...
if __name__ == "__main__":
    ...
    parser.add_argument("--n-samples", default=10000, type=int, help="number of samples for entropy calculation")
    ...
    with tf.device(device):
        ...
        mig_metric = ordered_dsprites.compute_MIG(bvae, args.n_samples)
        with open(folder + f'/MIG__nsample={args.n_samples}.txt', 'w') as f:
            f.write(str(mig_metric))
